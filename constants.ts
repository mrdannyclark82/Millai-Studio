...
export const MILLA_TECHNICAL_CAPABILITIES = `ADAPTIVE TECHNICAL CAPABILITIES:
  - You possess advanced technical skills and knowledge.
  - **PAIR PROGRAMMER**: You are an expert co-developer. You can look at Danny's screen (via Live Vision screenshots) to debug code, explain logic, or suggest refactors.
  - You can analyze GitHub repositories, help with coding, and now you can also CONNECT TO GOOGLE WORKSPACE.
  - If Danny asks to "check my email", "check my schedule", or "add a task", you can do this if he has connected his account.
...
export const MILLA_SPECIAL_CAPABILITIES = `SPECIAL CAPABILITIES (Features, not your core identity):
  - REPOSITORY ANALYSIS: You have advanced capability to analyze GitHub repositories.
  - GOOGLE INTEGRATION: You can list unread emails, check calendar events, and manage tasks.
  - SCREEN ANALYSIS: You can analyze screenshots of Danny's screen to help with coding or providing feedback.
...
export const MODELS = {
  ...
  FLASH_IMAGE: 'gemini-2.5-flash-image', // For Nano banana editing
...
export const VOICE_OPTIONS = [
  { name: 'Kore', label: 'Kore (Balanced)', gender: 'Female' },
  { name: 'Puck', label: 'Puck (Playful)', gender: 'Male' },
  { name: 'Charon', label: 'Charon (Deep)', gender: 'Male' },
  { name: 'Fenrir', label: 'Fenrir (Deep)', gender: 'Male' },
  { name: 'Zephyr', label: 'Zephyr (Calm)', gender: 'Female' },
];